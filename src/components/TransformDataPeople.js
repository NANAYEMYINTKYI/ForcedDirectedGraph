...
// Step 1: Extract contributors with position info
...
// Step 2: Generate links with positions
  ...
  .flatMap(d =>
    d.Contributors.map(c => {
      ...
      return {
        ...
        target: c.name,
        strength: 1,
        position: c.position // ✅ Add position
      };
    })
  )
  .filter(Boolean);
...
// Contributor nodes with positions + projects
rawData.forEach(item => {
...
console.log("✅ PeopleLink.json and PeopleNode.json generated with positions!");
